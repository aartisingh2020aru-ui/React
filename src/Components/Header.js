                    ...
                    <div class="ps-navigation__left">
                        <nav class="ps-main-menu">
                            <ul class="menu">
                                ...
                                <li class="has-mega-menu"><a href="contact-us.html">Contact Us</a></li>
                                <li class="has-mega-menu"><a href="blog-sidebar1.html">Blog</a></li>
                                <li class="has-mega-menu"><a href="my-account.html">My Account</a></li>


                                <li class="has-mega-menu"><a href="#">Products<span class="sub-toggle"><i class="fa fa-chevron-down"></i></span></a>
                                    <div class="mega-menu">
                                        <div class="container">
                                            <div class="mega-menu__row">
                                                <div class="mega-menu__column">
