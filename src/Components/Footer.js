                        ...
                        <div class="row ps-footer__box">
                            <div class="col-12 col-md-4">
                                <div class="ps-footer--contact">
                                    ...
                                    <hr />
                                    <p><a class="ps-footer__email" href="/cdn-cgi/l/email-protection#20434f4e54414354604558414d504c450e434f4d"> <i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="2f4c40415b4e4c5b6f4a574e425f434a014c4042">[email&#160;protected]</span> </a></p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                            ...
                                            <form action="do_action" method="post">
                                                <div class="ps-form--newsletter">
                                                    <div class="input-group">
                                                        <input class="form-control ps-input" type="text" placeholder="Enter your email address" />
